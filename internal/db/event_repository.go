...
func (r *EventRepository) InsertEvent(ctx context.Context, event EventRecord) error {
...
func (r *EventRepository) GetEvents(ctx context.Context) ([]EventRecord, error) {
...
func (r *EventRepository) GetEventsCount(ctx context.Context) (int, error) {
	var count int
...
func (r *EventRepository) GetUnProcessedEvents(ctx context.Context, batchSize int) ([]EventRecord, error) {
	rows, err := r.pool.Query(ctx, `
		SELECT 
			event_id,
			event_timestamp,
...
func (r *EventRepository) MarkEventAsProcessed(ctx context.Context, event EventRecord) error {
	_, err := r.pool.Exec(ctx,
...
func (r *EventRepository) GetEventsByTimeRange(ctx context.Context, start, end time.Time) ([]EventRecord, error) {
	rows, err := r.pool.Query(ctx, `
		SELECT 
			event_id,
			event_timestamp,
